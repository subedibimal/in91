...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
   {
    //    dd($request->all());
        ...
        if($request->product_type == "affiliate")
        {
        ...
        $product->wholeseller_id = $request->wholeseller_id;
...
//        $product->tax_type = $request->tax_type;
        ...
        $wholesale->discount_f1 = $request->discount_f1;
        $wholesale->quantity_f2 = $request->quantity_f2;
        $wholesale->discount_f2 = $request->discount_f2;
        $wholesale->quantity_f3 = $request->quantity_f3;
        $wholesale->discount_f3 = $request->discount_f3;
        $wholesale->quantity_f4 = $request->quantity_f4;
        $wholesale->discount_f4 = $request->discount_f4;
        $wholesale->save();
...
//            dd($flash_deal_product);
    ...
    public function updatePincode(Request $request)
    {
        if(Auth::check()){
            ...
            $user->save();
            return Response::json($user['postal_code'], 200);
        }
        else{
            return 0;
        }
    ...
    public function updateDeliveryAddress(Request $request)
    {
        ...
        if($request->key == "daddress")
        {
            $user->address = $request->address;
            $user->save();
            flash(translate('City updated successfully'))->success();
        }
        else{
