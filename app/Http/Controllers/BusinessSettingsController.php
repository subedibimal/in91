...
class BusinessSettingsController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        $business = GeneralSetting::first();

        $business->phone = $request->phone;
        $business->promo_line = $request->promo_line;
        $business->promo_option = $request->promo_option;
        $business->promo_bgcolor = $request->promo_bgcolor;
        $business->promo_fontcolor = $request->promo_fontcolor;
        $business->header_msg = $request->header_msg;
