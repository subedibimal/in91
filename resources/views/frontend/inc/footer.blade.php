<footer class="page-footer footer-style-1 global_width" style="background-color:{{ get_setting('footer_bgcolor') }}; color: {{ get_setting('footer_color') }};">
        <div class="holder bgcolor bgcolor-1 mt-0"  style="background-color:{{ get_setting('global_color') }};">
            <div class="container">
        ...
        <div class="footer-bottom container">
            <div class="row lined py-2 py-md-3">
                ...
                <div class="col-md-auto ml-lg-auto mb-4 mb-md-0">
...
<a id="back-to-top" class="back-to-top js-back-to-top compensate-for-scrollbar is-visible" style="background-color:{{ get_setting('global_color') }};border-radius:.2rem;" href="#" title="Scroll To Top"><i class="icon icon-angle-up"></i></a>
...
<div class="aiz-mobile-bottom-nav d-xl-none fixed-bottom bg-white shadow-lg border-top">
    <div class="d-flex justify-content-around align-items-center">
        ...
        <a href="{{ route('cart') }}" class="text-reset flex-grow-1 text-center py-3 border-right {{ areActiveRoutes(['cart'],'bg-soft-primary')}}">
         ...
         <a href="https://wa.me/919654000505" class="text-reset flex-grow-1 text-center py-3 border-right {{ areActiveRoutes([''],'bg-soft-primary')}}">
