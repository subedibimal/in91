            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                @if(Auth::user()->user_type == 'admin' || in_array('13', json_decode(Auth::user()->staff->role->permissions)))
                  <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link">
                        <i class="las la-desktop aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text">{{translate('App Setup')}}</span>
                        <span class="aiz-side-nav-arrow"></span>
                    </a>
                    <ul class="aiz-side-nav-list level-2">
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('app.customer') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('Customer App')}}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('app.seller') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('Seller App')}}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('app.delivery_boy') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{translate('Delivery Boy App')}}</span>
                            </a>
                        </li>
                        {{--<li class="aiz-side-nav-item">
                            <a href="{{ route('app.pages') }}" class="aiz-side-nav-link {{ areActiveRoutes(['app.pages', 'custom-pages.create' ,'custom-pages.edit'])}}">
                                <span class="aiz-side-nav-text">{{translate('Pa')}}</span>
                            </a>
                        </li>--}}
                    </ul>
                </li>
