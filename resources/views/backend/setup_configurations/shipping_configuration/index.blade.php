...
<div class="row">
    <div class="col-lg-6">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0 h6">{{translate('Minimum Cart Price for Free Shipping')}}</h5>
            </div>
            <form action="{{ route('shipping_configuration.update') }}" method="POST" enctype="multipart/form-data">
              <div class="card-body">
                  @csrf
                  <input type="hidden" name="type" value="min_price_free_shipping">
                  <div class="form-group">
                      <div class="col-lg-12">
                          <input class="form-control" type="text" name="min_price_free_shipping" value="{{ get_setting('min_price_free_shipping') }}">
                      </div>
                  </div>
                  <div class="form-group mb-0 text-right">
                      <button type="submit" class="btn btn-sm btn-primary">{{translate('Save')}}</button>
    ...
    <div class="col-lg-6">
        <div class="card">
            ...
            <div class="card-body">
                <ul class="list-group">
                    <li class="list-group-item">
                        {{ translate('1. Minimum Cart Price Wise Free Shipping is applicable if total cart amount of the user is greater than the price mentioned here . Leave blank if you donot want to include this facility in your site.') }}
                    </li>
                </ul>
            </div>
        </div>
