    			...
    			<div class="card-body">
    				<form action="{{ route('business_settings.update') }}" method="POST">
    	                ...
    	                <div class="form-group row">
    	                 ...
    	                 <div class="form-group row">
    	                    <label class="col-md-3 col-from-label">{{translate('Website Global Color')}}</label>
                            <div class="col-md-8">
                                <input type="hidden" name="types[]" value="global_color">
        	                    <input type="text" name="global_color" class="form-control" placeholder="#377dff" value="{{  get_setting('global_color') }}">
        						<small class="text-muted">{{ translate('Hex Color Code') }}</small>
                            </div>
    	                </div>
    	                <div class="form-group row">
    	                    <label class="col-md-3 col-from-label">{{translate('Website Background Color')}}</label>
                            <div class="col-md-8">
                                <input type="hidden" name="types[]" value="background_color">
        	                    <input type="text" name="background_color" class="form-control" placeholder="#377dff" value="{{  get_setting('background_color') }}">
        						<small class="text-muted">{{ translate('Hex Color Code') }}</small>
                            </div>
    	                </div>
