    		...
    		<div class="row gutters-10">
    			<div class="col-lg-12">
    				<div class="card shadow-none bg-light">
    					<div class="card-header">
    						<h6 class="mb-0">{{ translate('Footer Logo Widget') }}</h6>
    					</div>
    					<div class="card-body">
                    ...
                    <div class="card shadow-none bg-light">
    					...
    					<div class="card-body">
                            <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
    							...
    							<div class="form-group">
    								<label>{{ translate('Contact hours') }}</label>
    								<input type="hidden" name="types[]" value="contact_hours">
    								<input type="text" class="form-control" placeholder="{{ translate('Hours') }}" name="contact_hours" value="{{ get_setting('contact_hours') }}">
    							</div>
    							<div class="text-right">
    								<button type="submit" class="btn btn-primary">{{ translate('Update') }}</button>
    							</div>
    			...
    			<div class="col-lg-12">
                    <div class="card shadow-none bg-light">
    					<div class="card-header">
    						<h6 class="mb-0">{{ translate('Features Widget') }}</h6>
    					</div>
    					<div class="card-body">
                            <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
                                @csrf
    			                <div class="form-group">
    								...
    								<div class="w3-links-target">
    									...
    									<input type="hidden" name="types[]" value="feature_desc">
    									@if (get_setting('feature_title') != null)
    										@foreach (json_decode(App\BusinessSetting::where('type', 'feature_title')->first()->value, true) as $key => $value)
    											<div class="row gutters-5">
    												<div class="col-4">
    													<div class="form-group">
    														<input type="text" class="form-control" placeholder="Title" name="feature_title[]" value="{{ $value }}">
    													</div>
    												</div>
    												<div class="col">
    													<div class="form-group">
    														<input type="text" class="form-control" placeholder="Description" name="feature_desc[]" value="{{ json_decode(App\BusinessSetting::where('type', 'feature_desc')->first()->value, true)[$key] }}">
    													</div>
    												</div>
    											</div>
    										@endforeach
    			...
    			<div class="col-lg-12">
                    <div class="card shadow-none bg-light">
    					<div class="card-header">
    						<h6 class="mb-0">{{ translate('Footer Category Widget') }}</h6>
    					</div>
    					<div class="card-body">
                            <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
                                @csrf
    							<div class="form-group">
    								...
    								<input type="hidden" name="types[]" value="footer_categories_widget">
    								<input type="text" class="form-control" placeholder="Widget title" name="footer_categories_widget" value="{{ get_setting('footer_categories_widget') }}">
    							</div>
    			                <div class="form-group">
    								<label>{{ translate('Links') }}</label>
    								<div class="w3-links-target">
    									<input type="hidden" name="types[]" value="categories_widget_labels">
    									<input type="hidden" name="types[]" value="categories_widget_links">
    									@if (get_setting('categories_widget_labels') != null)
    										@foreach (json_decode(App\BusinessSetting::where('type', 'categories_widget_labels')->first()->value, true) as $key => $value)
    											<div class="row gutters-5">
    												<div class="col-4">
    													<div class="form-group">
    														<input type="text" class="form-control" placeholder="Label" name="categories_widget_labels[]" value="{{ $value }}">
    													</div>
    												</div>
    												<div class="col">
    													<div class="form-group">
    														<input type="text" class="form-control" placeholder="http://" name="categories_widget_links[]" value="{{ json_decode(App\BusinessSetting::where('type', 'categories_widget_links')->first()->value, true)[$key] }}">
    													</div>
    												</div>
    												<div class="col-auto">
    								...
    								<button
    									...
    									data-content='<div class="row gutters-5">
    										<div class="col-4">
    											<div class="form-group">
    												<input type="text" class="form-control" placeholder="Label" name="categories_widget_labels[]">
    											</div>
    										</div>
    										<div class="col">
    											<div class="form-group">
    												<input type="text" class="form-control" placeholder="http://" name="categories_widget_links[]">
    											</div>
    										</div>
    										<div class="col-auto">
    											<button type="button" class="mt-1 btn btn-icon btn-circle btn-sm btn-soft-danger" data-toggle="remove-parent" data-parent=".row">
    ...
    <div class="card">
        ...
        <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
           ...
           <div class="card-body">
                ...
                <div class="card shadow-none bg-light">
                  <div class="card-header">
        						<h6 class="mb-0">{{ translate('Footer Settings') }}</h6>
        					</div>
                  <div class="card-body">
                        <div class="form-group">
							<label>{{ translate('Background color') }}</label>
							<input type="hidden" name="types[]" value="footer_bgcolor">
							<input type="color" class="form-control" placeholder="{{ translate('Background color') }}" name="footer_bgcolor" value="{{ get_setting('footer_bgcolor') }}">
						</div>
                       
                       <div class="form-group">
							<label>{{ translate('Text color') }}</label>
							<input type="hidden" name="types[]" value="footer_color">
							<input type="color" class="form-control" placeholder="{{ translate('Text color') }}" name="footer_color" value="{{ get_setting('footer_color') }}">
						</div>
