            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="col-md-6">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input type="radio" name="product_type" value="affiliate">
                                    <span></span>
                                </label>
                            </div>
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control" name="quantity_f1" placeholder="{{ translate('Product Quantity') }}">
                            </div>
                            <div class="col-md-4">
                                <input type="text" class="form-control" name="discount_f1" placeholder="{{ translate('Discount Percent') }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Offer Two')}}</label>
                            <div class="col-md-4">
                                <input type="text" class="form-control" name="quantity_f2" placeholder="{{ translate('Product Quantity') }}">
                            </div>
                            <div class="col-md-4">
                                <input type="text" class="form-control" name="discount_f2" placeholder="{{ translate('Discount Percent') }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Offer Three')}}</label>
                            <div class="col-md-4">
                                <input type="text" class="form-control" name="quantity_f3" placeholder="{{ translate('Product Quantity') }}">
                            </div>
                            <div class="col-md-4">
                                <input type="text" class="form-control" name="discount_f3" placeholder="{{ translate('Discount Percent') }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Offer Four')}}</label>
                            <div class="col-md-4">
                                <input type="text" class="form-control" name="quantity_f4" placeholder="{{ translate('Product Quantity') }}">
                            </div>
                            <div class="col-md-4">
                                <input type="text" class="form-control" name="discount_f4" placeholder="{{ translate('Discount Percent') }}">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input type="checkbox" name="wholeseller_id" value="1">
                                    <span></span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <label class="aiz-switch aiz-switch-success mb-0">
                                            <input type="checkbox" name="customer_support" value="1" checked>
                                            <span></span>
                                        </label>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <label class="aiz-switch aiz-switch-success mb-0">
                                            <input type="checkbox" name="genuine" value="1" checked>
                                            <span></span>
                                        </label>
                                    </div>
                                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="return_days" class="form-control" placeholder="Enter return days...">
                        </div>
                        <div class="form-group mb-3">
                            <label for="name">
