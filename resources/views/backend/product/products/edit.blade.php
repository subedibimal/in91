            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row" id="brand">
                            <label class="col-md-3 col-from-label">{{translate('Origin Country')}}</label>
                            <div class="col-md-8">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6">{{translate('Affiliate Product')}}</h5>
                        <div class="col-md-6">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input type="radio" name="product_type" value="affiliate" @if($product->product_type == 'affiliate') checked @endif>
                                    <span></span>
                                </label>
                            </div>
                    </div>
                      <div class="card-body">
                        <div class="form-group row">
                            <label class="col-md-5 col-from-label">{{translate('Affiliate Link')}}</label>
                            <div class="col-md-7 ">
                        ...
                        <div class="form-group row">
                            <label class="col-md-5 col-from-label">{{translate('Button Name')}}</label>
                            <div class="col-md-7 ">
...
<!--                        <div class="form-group row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Offer One')}}</label>
                            <div class="col-md-4">
                                <input type="text" class="form-control" name="quantity_f1" value="{{ $wholesale->quantity_f1 ?? ''}}" placeholder="{{ translate('Product Quantity') }}">
                            </div>
                            <div class="col-md-4">
                                <input type="text" class="form-control" name="discount_f1" value="{{ $wholesale->discount_f1 ?? ''}}" placeholder="{{ translate('Discount Percent') }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Offer Two')}}</label>
                            <div class="col-md-4">
                                <input type="text" class="form-control" name="quantity_f2" value="{{ $wholesale->quantity_f2 ?? ''}}" placeholder="{{ translate('Product Quantity') }}">
                            </div>
                            <div class="col-md-4">
                                <input type="text" class="form-control" name="discount_f2" value="{{ $wholesale->discount_f2 ?? ''}}" placeholder="{{ translate('Discount Percent') }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Offer Three')}}</label>
                            <div class="col-md-4">
                                <input type="text" class="form-control" name="quantity_f3" value="{{ $wholesale->quantity_f3 ?? ''}}" placeholder="{{ translate('Product Quantity') }}">
                            </div>
                            <div class="col-md-4">
                                <input type="text" class="form-control" name="discount_f3" value="{{ $wholesale->discount_f3 ?? ''}}" placeholder="{{ translate('Discount Percent') }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Offer Four')}}</label>
                            <div class="col-md-4">
                                <input type="text" class="form-control" name="quantity_f4" value="{{ $wholesale->quantity_f4 ?? ''}}" placeholder="{{ translate('Product Quantity') }}">
                            </div>
                            <div class="col-md-4">
                                <input type="text" class="form-control" name="discount_f4" value="{{ $wholesale->discount_f4 ?? ''}}" placeholder="{{ translate('Discount Percent') }}">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input type="checkbox" name="wholeseller_id" value="1" @if($product->wholeseller_id == 1) checked @endif>
                                    <span></span>
                                </label>
                            </div>
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <div class="col-md-12">
                                <div class="form-group row">
                                    <label class="col-md-6 col-from-label">{{translate('24/7 Customer support')}}</label>
                                    <div class="col-md-6">
                                        <label class="aiz-switch aiz-switch-success mb-0">
                                            <input type="checkbox" name="customer_support" value="1" @if($product->customer_support == 1) checked @endif>
                                            <span></span>
                                        </label>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-md-6 col-from-label">{{translate('100% Genuine')}}</label>
                                    <div class="col-md-6">
                                        <label class="aiz-switch aiz-switch-success mb-0">
                                            <input type="checkbox" name="genuine" value="1" @if($product->genuine == 1) checked @endif>
                                            <span></span>
                                        </label>
                                    </div>
                                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="return_days" value="{{ $product->return_days }}" class="form-control" placeholder="Enter return days...">
                        </div>
                        <div class="form-group mb-3">
                            <label for="name">
                                {{translate('Warranty time')}}
                            </label>
