        ...
        <div class="card">
            <div class="card-body p-0">
                ...
                <form class="p-4" action="{{ route('categories.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label">{{translate('Background Color')}}</label>
                        <div class="col-md-4">
                            <input type="color" class="form-control" name="bg_color" placeholder="{{translate('Background Color')}}" value="{{ $category->bg_color }}">
                        </div>
                    </div>
