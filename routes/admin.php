...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
    ...
    Route::group(['prefix' => 'app'], function() {
        Route::view('/customer', 'backend.app_settings.customer')->name('app.customer');
        Route::view('/seller', 'backend.app_settings.seller')->name('app.seller');
        Route::view('/delivery_boy', 'backend.app_settings.delivery_boy')->name('app.delivery_boy');
    });
