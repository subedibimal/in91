...
Route::get('admin/users/login', '\App\Http\Controllers\Auth\LoginController@showLoginForm');
...
// Delivery address
Route::post('/user/address', 'ProductController@updateAddress')->name('update.deliveryAddress');
Route::post('/user/pincode', 'ProductController@updatePincode')->name('update.deliveryPincode');

Route::post('/delivery/address', 'ProductController@updateDeliveryAddress')->name('update.address');
